...
namespace Teste.Infrastructure.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class AddEcommerceAndCategories : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_Status", "[Status] IN ('INICIADO', 'PROCESSADO', 'ENVIADO', 'CANCELADO')");
                    table.ForeignKey(
